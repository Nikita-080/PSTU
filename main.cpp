...
void Proc_list_1()
{
    ...
    else cout << "Результат: список удален\n";
    DEL_list_1(LIST);
}
...
void Proc_stack_lib()
{
    ...
    if (STACK.empty()) cout << "Результат: стек удален\n";
    else
    {
        cout << "Результат\n";
...
int main()
{
    ...
    {
        cout << "\n";
        cout << "Однонаправленный список.............1\n";
        cout << "Двунаправленный список (функции)....2\n";
        cout << "Двунаправленный список (библиотека).3\n";
        cout << "Стек (функции)......................4\n";
        cout << "Стек (библиотека)...................5\n";
        cout << "Очередь (функции)...................6\n";
        cout << "Очередь (библиотека)................7\n";
        cout << endl;
        cout << "Введите номер работы\n";
        cin >> work;
        while (len<2)
        {
            cout << "Введите длину структуры:\n";
            cin >> len;
        }
        switch (work)
        {
